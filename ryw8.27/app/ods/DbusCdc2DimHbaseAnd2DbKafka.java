...
import com.app.func.MapUpdateHbaseDimTableFunc;
import com.app.func.ProcessSpiltStreamToHBaseDimFunc;
import com.stream.common.utils.ConfigUtils;
import com.stream.common.utils.EnvironmentSettingUtils;
import com.stream.common.utils.KafkaUtils;
import com.app.stream.utils.CdcSourceUtils;
...
public class DbusCdc2DimHbaseAnd2DbKafka {
    ...
    public static void main(String[] args) {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///D:/gongdan07/flink-chk");
        ...
        MySqlSource<String> mySQLCdcDimConfSource = CdcSourceUtils.getMySQLCdcSource(
                ...
                "realtime_v1_config.dim_config",        // 配置表
