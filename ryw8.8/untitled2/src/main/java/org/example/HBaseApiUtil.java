...
public class HBaseApiUtil {
    ...
    public static void createHBaseTable(Connection conn,
                                        String nameSpace,
                                        String table,
    ...
    public static void dropHBaseTable(String nameSpace,
                                      String table) throws IOException {
        Admin admin = getHBaseConnection().getAdmin();
        //AsyncAdmin admin1 = getHBaseAsyncConnection().getAdmin();
        TableName tableName = TableName.valueOf(nameSpace, table);
        if (admin.tableExists(tableName)) {
    ...
    public static void delRow(
        ...
        TableName tableName = TableName.valueOf(nameSpace, table);
        Table t = getHBaseConnection().getTable(tableName);
